...
public class MinesweeperServer {
    ...
    private static final String[] HELLO_MSG = 
            new String[] {"Welcome to minesweeper. Players: ", " including you. Board: ",
    ...
    */
    ...
    private String buildMessage (MessageType msgType) {
        ...
        case HELLO:
            ...
            builder.append(HELLO_MSG[0]).append(numPlayers).append(HELLO_MSG[1]).append(x)
                   .append(HELLO_MSG[2]).append(y).append(HELLO_MSG[3]);
